    ...
    $(document).ready(function() {
        ...
        $('#calendar').fullCalendar({
            ...
            eventClick: function(calEvent, jsEvent, view) {
                ...
                $('#end').val(moment(calEvent.end).format('YYYY/MM/DD'));
            ...
            eventDrop: function(calEvent, event, delta, revertFunc) {
                ...
                /*$.ajax({
                    ...
                    data: { id: event.id, start: event.start + ' ' + $('#startTime').val(), end: $('#end').val() + ' ' + $('#endTime').val(), title: $('#title').val(), user_id: $rootScope.user.loginId },
                    type: "POST",
                    datatype: "json",
                ...
                */
                ...
                alert(event.title + "뭔데이거"+ event.start.format());
